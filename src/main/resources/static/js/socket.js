...
async function onConnected() {
    ...
    // Fetch online users list first to avoid race condition with UI render
    try {
        ...
        console.error("Lỗi tải online-users:", error);
    }

    // Load Data after presenceStatus has been populated
